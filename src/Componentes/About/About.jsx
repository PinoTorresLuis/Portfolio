...
import img from '../../media/imgtest 1.png';
...
const About = () => {
  return (
    <div className='about_container'><a name="about"></a>
     <div className='wave_container_top'>
          <svg className='wave_svg_top' viewBox="0 0 500 150" preserveAspectRatio="none">
          <path className='path_svg_top' d="M-0.27,74.52 C179.73,276.81 466.42,-65.61 500.84,63.66 L500.00,150.00 L0.00,150.00 Z"></path>
          </svg>
          </div>
